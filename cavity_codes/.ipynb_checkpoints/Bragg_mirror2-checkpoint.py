...
def Bragg_mirror(photon_energies_eV, angles_rad, d = 100e-6,reflectionQ=True, undo_slippageQ=True, undo_xshiftQ=True):
    ...
    chi_0  = -3.0289e-05+1j*9.0941e-08   # Diamond electric susceptibility vacuum for (220)
    chi_h = 9.6964e-06-1j*8.8126e-08
    chi_hbar = chi_h; # for centro-symmetric crystal
    ############################################################
    dh = 1.2611e-10;# #interplanar distance (d-spacing?) (for 220 diamond at 6952 eV for 45 degree bragg?)
