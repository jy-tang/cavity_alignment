...
t0 = time.time()
jobid = start_recirculation(zsep = zsep, ncar = ncar, dgrid = dgrid, nslice = nslice, xlamds=xlamds, w0=31.8e-6,  trms=20.e-15,  peak_power = 1e10,          # dfl params
                             ...
                             readfilename = None ,
                            delta1 = 0, delta2 =0, delta3 = 0, delta4 = 200e-9,   #yaw angle error on each of the mirror
